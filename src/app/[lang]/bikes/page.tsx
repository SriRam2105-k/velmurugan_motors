    ...
    <>
      ...
      <section className="bg-[#0f172a] pt-32 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold text-white mb-4">{dict.bikes.header.title}</h1>
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Category Pills */}
          <div className="flex gap-2 sm:gap-3 flex-wrap mb-10">
            {categories.map((cat) => (
              <button
                key={cat}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 min-h-[400px]">
            ...
            {filteredBikes.length === 0 && (
              <div className="col-span-full flex flex-col items-center justify-center py-20 text-slate-400">
                <p className="text-lg font-medium">No bikes found in this category.</p>
              </div>
            )}
          </div>
